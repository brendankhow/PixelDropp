...
export function ProductCard({ product, priority = false }: ProductCardProps) {
  ...
  return (
    ...
    >
      <div
        className={`relative w-full overflow-hidden bg-page-alt ${
      ...
      <div className="flex flex-col flex-1 p-4 gap-3">
        <div className="flex-1">
          <h3 className="font-semibold text-fg text-sm leading-snug group-hover:text-fg transition-colors line-clamp-2">
            {product.name}
          </h3>
          {product.description && (
